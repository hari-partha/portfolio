  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Couple this with external AI LLM tools like ESMFold 3, or Evo 2 by the Arc Institute that recently populated the open source stream, and suddenly, this is a very different conversation we are having about bio-based LLMs than even just a year ago.',
