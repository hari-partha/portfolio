/**
 * Rolling admissions essay — append new `Insight` objects as you publish more days.
...
export const admissionsIntroParagraphs: string[] = [
  ...
  'So I’ve drafted them as short LinkedIn insights. One post per day, for the month of April. For admitted students. For the parents trying to help. For the siblings and friends who shape this decision more than they realize. Here’s Day 1.',
];

export const admissionsRollingNote =
  'This page is a living draft — I’ll keep appending insights here as I write them. What you see below is the set I’m ready to share for April 25.';
...
export const admissionsInsights: Insight[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Connection: When I first began exploring venture capital, I had no connections in the space. Just me and my roommate, without a single contact to partners, analysts, or even a founder who was just starting out. So we did what felt natural—we reached out to two people within our program whom we knew well, hoping they could guide us in the right direction. Not through cold emails or LinkedIn templates, but through calls that felt personal, honest, and grounded. One was a founder who shared perspectives on how to build towards our vision and understand founder-level problems. The other is a senior who built his own fund platform. Impressed by our hustle and our “implicit confidence” (read Blog 5 for more on this), he even offered us an opportunity to work with him, serving as a mentor and catalyst for our real-world explorations of VC theory. These two conversations also led to more conversations, which led to more introductions, more conversations, and a virtuous cycle of organic network growth. A few months later, my roommate and I had both built networks we couldn’t have achieved solely through cold emails and blank requests. That’s the nature of connection -- it doesn’t scale by broadcasting. It scales by going deep on a few and letting introductions flow from there.',
