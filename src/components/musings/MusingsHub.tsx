...
export function MusingsHub({ brainfoodPosts, soulfoodPosts }: MusingsHubProps) {
  ...
  return (
    <main className="musings-hub min-h-screen bg-[var(--ed-paper,#f8fafc)]">
      <section className="musings-hero editorial-theme">
        <Link href="/" className="musings-back-arrow" aria-label="Back to portfolio">
          ←
        </Link>

        <p className="editorial-kicker">Musings</p>
        <h1 className="musings-hero-title">Hi, I&apos;m Hari.</h1>
        ...
        <div className="musings-about">
          ...
          <p className="editorial-p musings-about-last">
      ...
      <div className={brandPanelClass}>
        <section className="editorial-intro-band musings-brand-band">
          ...
          <h2 className="musings-brand-welcome">{copy.welcome}</h2>
          <p className="editorial-p musings-brand-intro">{copy.intro}</p>
        </section>

        <div className="musings-posts-wrap">
